...
-Weight selectiuon and Normalization Strategy.
  ...
  - The competition had given formula's but not the actual weights. Here is the final weight decided after multiple tries
   ...
   - Crowd Level      -   15%  -  Crowd is something that different people have different opinion on. Some places are fun with more crowd but some arent. The weight was given of 15%. This means crowded placess can stil be
